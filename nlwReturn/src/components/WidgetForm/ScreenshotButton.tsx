...
interface ScreenshotButtonProps {
  ...
  onClickTackScreenshot: (screenshot: string | null) => void;
}
export function ScreenshotButton(
  { 
    onClickTackScreenshot, screenshot 
    ...
    onClickTackScreenshot(base64image);
  ...
  if (screenshot) {
    return (
      <button 
        ...
        onClick={() => onClickTackScreenshot(null)}
        style={{
  ...
  >
    { isScreenshotReady ? <Loading /> : <Camera weight="bold" className="w-4 h-4" /> }
  </button>
  )
}
